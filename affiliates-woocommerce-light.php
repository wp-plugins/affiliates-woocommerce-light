...
class Affiliates_WooCommerce_Light_Integration {
    ...
    public static function affiliates_admin_woocommerce_light() {
        ...
        $output .= '<p class="manage" style="padding:2em;margin-right:1em;font-weight:bold;font-size:1.31em;line-height:1.62em">';
        $output .= __( 'Get more cool features with <em style="color:#00a651;">Affiliates Pro</em> included in the <em style="color:#a46497;">Affiliates WooCommerce Integration Pack</em>.', AFF_WOOCOMMERCE_LIGHT_PLUGIN_DOMAIN );
        // @todo enable link when available on http://www.woothemes.com/extensions/woocommerce-extensions/
        //$output .= __( 'Download it on <a href="http://www.itthinx.com/plugins/affiliates-woocommerce/" target="_blank">itthinx.com</a> or <a href="http://woocommerce.com/extension/affiliates-pro-integration-pack/" target="_blank">woocommerce.com</a>.', AFF_WOOCOMMERCE_LIGHT_PLUGIN_DOMAIN );
        $output .= __( 'Download it on <a href="http://www.itthinx.com/plugins/affiliates-woocommerce/" target="_blank">itthinx.com</a>.', AFF_WOOCOMMERCE_LIGHT_PLUGIN_DOMAIN );
        $output .= '</p>';
    ...
    public static function affiliates_footer( $footer ) {
        ...
        '<div style="font-size:0.9em">' .
            '<p>' .
            __( "Cool! Your site is powered by the <img src='http://www.itthinx.com/img/affiliates-woocommerce/affiliates-woocommerce-light.png' alt='Logo'/><a href='http://www.itthinx.com/plugins/affiliates-woocommerce-light' target='_blank'>Affiliates WooCommerce Integration Light</a>.", AFF_WOOCOMMERCE_LIGHT_PLUGIN_DOMAIN ) .
            ' ' .
            __( 'Get even more awesome features with <em>Affiliates Pro</em> included in the <em>Affiliates WooCommerce Integration Pack</em>.', AFF_WOOCOMMERCE_LIGHT_PLUGIN_DOMAIN ) .
            ' ' .
            // @todo enable link when available on http://www.woothemes.com/extensions/woocommerce-extensions/
            //__( 'Download it on <a href="http://www.itthinx.com/plugins/affiliates-woocommerce/" target="_blank">itthinx.com</a> or <a href="http://woocommerce.com/extension/affiliates-pro-integration-pack/" target="_blank">woocommerce.com</a>.', AFF_WOOCOMMERCE_LIGHT_PLUGIN_DOMAIN ) .
            __( 'Download it on <a href="http://www.itthinx.com/plugins/affiliates-woocommerce/" target="_blank">itthinx.com</a>.', AFF_WOOCOMMERCE_LIGHT_PLUGIN_DOMAIN ) .
            '</p>' .
            '</div>' .
            $footer;
    }
